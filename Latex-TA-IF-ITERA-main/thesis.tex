...
\begin{document}
    ...
    \title{Pengembangan Sistem Terintegrasi Penerimaan Mahasiswa Baru Berbasis Web Menggunakan Metode Prototype (Studi Kasus: Universitas HKBP Nommensen)}
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{Development of an Integrated Web-Based Student Admission System Using the Prototype Method (Case Study: HKBP Nommensen University)}
    % JUDUL AKAN DITULIS DALAM HURUF KAPITAL; Font size 16 pt; Bold; Tidak melebihi 4 baris
    
    % Informasi Mahasiswa
	\author{Mychael Daniel N}		% Nama Mahasiswa
	\nim{122140104}				% NIM Mahasiswa
