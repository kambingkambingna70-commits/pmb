...
class CamabaFormControllerTest {
    ...
    void registerAdmission_returns201() throws Exception {
        ...
        CamabaFormController.RegistrationRequest req = new CamabaFormController.RegistrationRequest();
        req.setPeriodId(1L);
    ...
    void testSelectionType_noId_returns400() throws Exception {
        // Sending an invalid (non-numeric) selectionTypeId triggers NumberFormatException
        // which is caught by the controller and returns 400
        mockMvc.perform(post("/api/camaba/test-selection-type")
    ...
    void submitRevision_returns200() throws Exception {
        when(admissionFormService.submitRevision(
